    ...
    this.attribs = input.slice(1).trim()
      ...
      .reduce((attribs, s, _) => {
        ...
        if (value) {
          ...
          // Handle attributes without values (like :flex)
          attribs[key] = true;
        }
        return attribs;
      }, {});
...
**✅ 推荐格式 - 计算器布局**：
(w :grid :cols "repeat(4, 1fr)" :cw 60px :ch 60px
  (1 :t "7")
  (1 :t "8")
  (1 :t "9")
  (1 :t "÷")
...
**✅ 推荐格式 - 导航菜单**：
(b :flex :dir 0 :cw 120px :ch 40px :bg "#f0f0f0"
  (1 :t "首页")
  (1 :t "产品")
  (1 :t "服务")
  (1 :t "关于")
...
**✅ 推荐格式 - 卡片网格**：
(w :grid :cols "repeat(3, 1fr)" :cw 200px :ch 150px
  (b :flex :dir 1 :bg "#fff"
    (p :t "标题1")
    (p :t "内容描述")
  )
...
**❌ 冗余格式 - 重复属性**：
(b :flex :dir 0
  (i :t "1" :w 100px :h 100px)
  (i :t "2" :w 100px :h 100px)
  (i :t "3" :w 100px :h 100px)
  (i :t "-" :w 100px :h 100px)
)

**❌ 冗余格式 - 重复背景色**：
(w :grid :cols "repeat(4, 1fr)"
  (1 :t "7" :w 60px :h 60px :bg "#e0e0e0")
  (1 :t "8" :w 60px :h 60px :bg "#e0e0e0")
  (1 :t "9" :w 60px :h 60px :bg "#e0e0e0")
  (1 :t "÷" :w 60px :h 60px :bg "#e0e0e0")
)
